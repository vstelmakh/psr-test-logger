...
Thank you for the interest in the **PSR Test Logger** library. If you find a problem or want to discuss new features,
...
6. Publish a pull request and wait for review.
